...
const EstimateMachineInfo = ({ form, handleChange, handlePartsChange }) => {
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="flex flex-col md:flex-row md:items-start md:space-x-4 col-span-1 md:col-span-2 gap-4">
          ...
          <div className="flex-1 flex flex-col">
            <label className="text-pink-600 font-medium mb-1">Date</label>
            <input
              type="date"
              name="machineDate"
              value={form.machineDate || ""}
              onChange={handleChange}
              className="border border-gray-300 rounded-md px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-400"
            />
          </div>
          ...
          <div className="flex-1 flex flex-col relative">
            <label className="text-purple-600 font-medium mb-1">Parts / Estimate</label>
            <div
